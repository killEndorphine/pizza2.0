  ...
  return (
    <div className="flex items-center justify-center h-screen max-h-[79vh]">
      <div className="flex flex-col items-center justify-center border w-1/3 h-2/4">
        <h1 className="mb-2 text-white">Регистрация аккаунта</h1>
        <div className="mb-1">
        ...
        <div className="flex mt-1">
          <button className="mb-2 text-white border p-2 mr-2">
            Зарегистрироваться
          </button>
          <Link to="/login" className="mb-2 text-white border p-2">
            Войти
          </Link>
        </div>
      </div>
